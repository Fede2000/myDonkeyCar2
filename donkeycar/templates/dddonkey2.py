...
def drive(cfg, model_path=None, use_joystick=False):
    ...
    controller_left = dk.parts.PCA9685(cfg.DD_STEERING_CHANNEL_LEFT)
    controller_right = dk.parts.PCA9685(cfg.DD_STEERING_CHANNEL_RIGHT)
    diffdrive = dk.parts.L298N(controller_left=controller_left,
